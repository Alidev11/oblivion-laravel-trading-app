...
@section('content')
    ...
    <div id="scrolablle-div" class="scrollbar1 srollable-div container">
        @if (Session::has('success'))
            <div class="alert alert-success d-flex align-items-center alertDiv alert-dismissible fade show" role="alert">
                <div>
        ...
        @elseif (Session::has('error'))
            <div class="alert alert-danger d-flex align-items-center alertDiv alert-dismissible fade show" role="alert">
                <div>
                    ...
                    <div class="col-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mt-3">
                                    <form id="bot-destroy-form" class="col"
                                        action="javascript:void(0)" method="POST" data-id_mi="{{$invest->id_mi}}">
                                        @csrf
