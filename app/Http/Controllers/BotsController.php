...
class BotsController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            ...
            Session::flash('error', 'Failed to add bot. ' . $e->getMessage());
    ...
    {
        try {
            // Your existing code for updating a bot
            ...
            // Handle exception and create a session variable 'error' with a message
            Session::flash('error', 'Failed to update bot. ' . $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            // Handle exception and create a session variable 'error' with a message
            Session::flash('error', 'Failed to delete bot. ' . $e->getMessage());
